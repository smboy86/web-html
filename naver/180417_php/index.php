<?php
    // ref. https://kin.naver.com/qna/detail.nhn?d1id=1&dirId=1040203&docId=299505898&page=1#answer1
    // Question 1
    ...
    class StudentInfo {
        ...
        public $intSubKoreanScore;
        public $intSubEnglishScore;
        public $intSubMathScore;
    ...
    // main
    $StuA = new StudentInfo();
    $StuA->strStuId = '2018A0001';
    $StuA->strName = '학생A';
    $StuA->intSubKoreanScore = 15;
    $StuA->intSubEnglishScore = 20;
    $StuA->intSubMathScore = 30;

    $StuA->printScore();
    
    $StuB = new StudentInfo();
    $StuB->strStuId = '2018B0001';
    $StuB->strName = '학생B';
    $StuB->intSubKoreanScore = 90;
    $StuB->intSubEnglishScore = 92;
    $StuB->intSubMathScore = 72;
